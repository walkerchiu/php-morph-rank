...
class StatusLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testStatusLang()
    {
        ...
        $db_lang_1 = factory(StatusLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Status::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(StatusLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Status::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(StatusLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Status::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(StatusLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => Status::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(StatusLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Status::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(StatusLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => Status::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = StatusLang::find($db_lang_1->id);
            // Then
    ...
    public function testStatus()
    {
        ...
        // Get lang of record
            // When
            $record_1 = Status::find($db_morph_1->id);
            $lang_1   = StatusLang::find($db_lang_1->id);
            $lang_4   = StatusLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = Status::find($db_morph_2->id);
